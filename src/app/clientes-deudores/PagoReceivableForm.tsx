...
import { addReceivablePayment } from "./actions";
...
export function PagoReceivableForm({ receivableId, banks }: { receivableId: string; banks: BankOpt[] }) {
  const [state, formAction, pending] = useActionState(addReceivablePayment, null);
